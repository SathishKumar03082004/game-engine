...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/x64/Debug/game-engine
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/x86/Debug/game-engine
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/ARM64/Debug/game-engine
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/x64/Release/game-engine
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/x86/Release/game-engine
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/game-engine.exe
OBJDIR = obj/ARM64/Release/game-engine
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
$(OBJDIR)/Inspector.o: src/Editor/Inspector/Inspector.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/Engine.o: src/Engine/Core/Engine.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Transform.o: src/Engine/Math/Transform.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
...
$(OBJDIR)/Scene.o: src/Engine/Scene/Scene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Window.o: src/Engine/Window/Window.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
